...
import TailSpin from "../../../components/Loading/TailSpin";
...
const GeneralNameAndLogo = (general: IGeneral) => {
    ...
    useEffect(() => {
        if (Object.keys(general).length !== 0) setGeneral(general);
    }, []);
    return (
            ...
            <div className="create-store-form">
                <div className="form-input">
                    ...
                    <Input
                        ...
                        setState={handleStoreName}
                        placeholder="Enter Store Name"
                        maxLength={25}
                    />
                    <div className="store-name-length">
                        {generals.storeName ? generals.storeName.length : "0"}
                        /25
                    </div>
                </div>
                <div className="form-input">
