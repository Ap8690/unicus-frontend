...
export async function getNftById(chain: any, contractAddress: any, nftId: any,assetListed:any) {
    return await axios.get(
        `${BASE_URL}/nft/getNftById/${chain}/${contractAddress}/${nftId}?asset_listed=${assetListed}`,
        axiosConfig()
    );
}
