...
const BasicSettings = (general: IGeneral) => {
  ...
  const [showInSuperMarket, setShowInSuperMarket] = useState(
    generals.showInSuperMarket
  );
  const [marketPlaceAsHome, setMarketPlaceAsHome] = useState(
    generals.marketPlaceAsHome
  );
  ...
  const dateFormats = [{ value: "DD MMM, YYYY", text: "" }];
          ...
          <Row className="mt-5">
            <Col lg={6}>
              <SwitchWidget
                ...
                title={"Show my Stores's NFTs in NFTically Super Market"}
                subtitle={
                  "Turn this ON if you want to show your NFTs in NFTically Super Market"
                }
              />
            </Col>
          </Row>
