...
import { bscChain, ethChain, polygonChain, avalancheChain, tronChain } from '../../config'
    ...
    <Popover id="popover-basic" className="networks_modal">
      ...
      <div className="popover-body gfg">
        ...
        <div
          ...
          onClick={() => {
            selectNetwork("Matic",polygonChain);
          }}
        >
