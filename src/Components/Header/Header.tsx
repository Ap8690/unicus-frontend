...
import { bscChain, ethChain, polygonChain, avalancheChain } from '../../config'
...
const Header = (props: any) => {
    ...
    <Popover id='popover-basic' className='networks_modal'>
      ...
      <div className='popover-body gfg'>
        ...
        <div
          ...
          onClick={() => {
            selectNetwork('avalanche', avalancheChain)
          }}
        >
          <img style={{ width: '70%' }} src="polhttps://cryptologos.cc/logos/avalanche-avax-logo.svg?v=022ygon" alt='' />
        </div>
      </div>
    </Popover>
  )
  ...
  useEffect(() => {
    ...
    else if (get == avalancheChain) {
      dispatch(AddNetworks('avalanche'))
    }
    else {
