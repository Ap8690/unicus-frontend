...
const Dashboard = (props: any) => {
  ...
  async function addAccount() {
    ...
    axios
      .get(`${backendUrl}/users/addWallet/${account[0]}`, {
        headers: {
          Authorization: "Bearer " + accessToken,
        },
      })
  ...
  useEffect(() => {
    if (getUserNFT.length === 0 && userInfo && firstLoad) {
      axios
        .get(`${backendUrl}/nft/getNFTByUserId/${userInfo && userInfo._id}`)
        .then((res: any) => {
          setfirstLoad(false);
  ...
  return (
    <>
      ...
      <div id="back-image">
        ...
        <Box
          className={
            loadingBackground === false ? "hide-it" : "normal__loading"
          }
          sx={{ display: "flex" }}
        >
          <CircularProgress />
      ...
      <Container className="pos-rel">
        <div className="profile_section">
          ...
          <div className="profile-name">
            <h5 className="profile-name_h5 mt-8 pt-2">{userInfo.username}</h5>
            {userInfo.bio && (
              <h6
            ...
            <h6
              className="profile-name_h6 mt-8 pt-2 mb-2"
              style={{ fontSize: "16px" }}
            >
              Joined{" "}
              {userInfo &&
            ...
            >
              {userInfo && userInfo.facebook && userInfo.facebook.length > 0 && (
                <a href={userInfo.facebook} target="_blank">
                  <i className="fab fa-facebook-f"></i>
                </a>
              )}
              {userInfo && userInfo.instagram && userInfo.instagram.length > 0 && (
                <a href={userInfo.instagram} target="_blank">
                  <i className="fab fa-instagram"></i>
                </a>
              )}
              {userInfo && userInfo.discord && userInfo.discord.length > 0 && (
                <a href={userInfo.discord} target="_blank">
                  <i className="fab fa-discord"></i>
                </a>
              )}
              {userInfo && userInfo.linkedIn && userInfo.linkedIn.length > 0 && (
                <a href={userInfo.linkedIn} target="_blank">
                  <i className="fab fa-linkedin-in"></i>
                </a>
              )}
              {userInfo && userInfo.twitter && userInfo.twitter.length > 0 && (
          ...
          <div className="mb-5 dashboard_profile">
            <div className="row">
                ...
                <div className="add_nft__right">
                  <Form className="formGroup">
                    ...
                    <div style={{ display: "block" }}>
                      {fieldEmptyError.includes("Username") && (
                        <h3
                          style={{
                            marginBottom: "-1rem",
                          }}
                      ...
                      >
                        {updateUserProfile.userName.length}
                        /15
                      </p>
                    </div>
                    <Form.Group className="mb-3 input_form_group">
                    ...
                    <div style={{ display: "block" }}>
                      ...
                      >
                        {updateUserProfile.bio && updateUserProfile.bio.length}
                        /150
                      </p>
                    </div>
                    <Form.Group
                    ...
                    >
                      ...
                      <Form.Control
                        ...
                        value={updateUserProfile.facebook}
                        id="facebook"
                      />
                    ...
                    <Form.Group className="mb-3 input_form_group">
                      ...
                      <Form.Control
                        ...
                        value={updateUserProfile.twitter}
                        id="twitter"
                      />
                  ...
                  <Form className="formGroup">
                    ...
                    >
                      ...
                      <Form.Control
                        ...
                        value={updateUserProfile.instagram}
                        id="instagram"
                      />
                    ...
                    >
                      ...
                      <Form.Control
                        ...
                        value={updateUserProfile.discord}
                        id="discord"
                      />
                    ...
                    <Form.Group className="mb-3 input_form_group">
                      ...
                      <Form.Control
                        ...
                        value={updateUserProfile.linkedIn}
                        id="linkedIn"
                      />
              ...
              <Form.Group className="mb-3">
                <a className="btn_brand mr-3" onClick={updateUserDetails}>
                  Save Profile
                </a>
                <a
                  className="btn_brand"
        ...
        <div className="_user__id">
          ...
          {userInfo && userInfo.wallets && userInfo.wallets.length < 5 && (
            <span
              onClick={() => setOpen(true)}
              className="addNewWallet"
              style={{
                position: "relative",
                display: "flex",
                alignItems: "center",
            ...
            >
              <AddWallet style={{ height: "35px", width: "35px" }} />{" "}
              <span
                style={{
                  position: "absolute",
                  width: "140px",
        ...
        >
          <Share />
          <span className="show-share-dashboard" style={{ color: "#fff" }}>
            Share Profile
          </span>
        </div>
        {userInfo.isVerified && (
      ...
      >
        ...
        <Container>
          ...
          {getUserAuction.length === 0 &&
            getUserNFT.length === 0 &&
            !NFTSLoaded && (
              <h4 style={{ textAlign: "center", marginBottom: "15rem" }}>
                No items to display
              </h4>
            )}
        </Container>
