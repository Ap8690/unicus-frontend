...
//   //     await axios
//   //       .get(
//   //         `${BASE_URL}/auction/getAuctionById/${location.pathname
//   //           .split("/")
...
//   //         await axios
//   //           .get(
//   //             `${BASE_URL}/nft/getNftById/${res.data[0].tokenId}/${
...
//   //               sessionStorage.getItem(res.data.nft._id) === "true"
//   //             );
...
//   //     await axios
//   //       .get(
//   //         `${BASE_URL}/nft/getNftById/${location.pathname.split("/").pop()}/${
//   //           JSON.parse(localStorage.getItem("userInfo"))
//   //             ? JSON.parse(localStorage.getItem("userInfo"))._id
//   //             : "none"
//   //         }/${location.pathname.split("/")[2]}`
...
//   //           setnowDate(new Date());
//   //           setdateArray(
//   //             new Date(res.data.auction.auctionTimer).toString().split(" ")
//   //           );
//   //           setdateHours(
...
//   //           .then(async (res: any) => {
//   //             setnftInfo(res.data.nft);
//   //             console.log(res.data.nft.chain, typeof res.data.nft.chain);
//   //             if (res.data.nft.chain === Number(ethChain)) {
//   //               setprice("Eth");
//   //             } else if (res.data.nft.chain === Number(polygonChain)) {
//   //               setprice("Matic");
...
//             .post("https://batchmint.herokuapp.com/forbuyitem", data)
//             .then((response) => {
...
//               axios
//                 .post("https://batchmint.herokuapp.com/buyitem", data)
...
//                         userInfo: userAddress ? userAddress : userInfo.username,
//                       },
//                       axiosConfig
//                     )
//                     .then((res) => {
...
//                 await axios
//                   .get(
//                     `${BASE_URL}/users/addWallet/${accounts[0]}`,
//                     axiosConfig
//                   )
//                   .then(async (res: any) => {
//                     console.log(res);
...
//               const startBid = auctionInfo?.startBid / Math.pow(10, 18);
//               const value = await web3.utils.toWei(startBid.toString());
//               console.log("----------->", value);
//               const res = await getMarketPlace(auctionInfo.chain, auctionInfo.nftId.contractType).methods
...
//       }
//     }
//     if (paymentMode === "MetaMaskBuyItem" || paymentMode === "StripeBuyItem") {
//       buyItem();
//     }
//   }, [paymentMode]);
...
//           console.log(
//             nowDate && endDate && nowDate < endDate ? "Make Offer" : "Claim NFT"
//           );
//           var token;
//           if (networkID === bscChain) {
//             token = "BNB";
...
//           const gasPrice = await axios
//             .post("https://batchmint.herokuapp.com/forplacebid", data)
//             .then((response) => {
//               console.log(response.data);
//             });
...
//               console.log("STATUS ", status);
//               axios
//                 .post("https://batchmint.herokuapp.com/placebid", data)
//                 .then((createSaleAPI: any) => {
//                   console.log(createSaleAPI.data);
//                   axios
//                     .post(
...
//                       {
//                         nftId: props.location.state.message.nftId,
//                         auctionId: props.location.state.message.auctionId,
//                         bidValue: web3.utils.toWei(bid, "ether"),
//                         bidCurrency: "BNB",
//                         bidHash: "4754",
...
//                   });
//               }
//               const res = await getAuction(auctionInfo.chain, auctionInfo.nftId.contractType)
//                 .methods.placeBid(auctionInfo.auctionId)
//                 .send({
//                   from: accounts[0],
...
//             axios
//               .post("https://batchmint.herokuapp.com/endsale", data)
//               .then((createSaleAPI: any) => {
//                 console.log(createSaleAPI.data);
//                 axios
//                   .post(
...
//               };
//               await axios
//                 .get(`${BASE_URL}/users/addWallet/${accounts[0]}`, axiosConfig)
//                 .then(async (res: any) => {
//                   console.log(res);
//                   localStorage.setItem(
//                     "userInfo",
...
//                 });
//             }
//             const res = await getMarketPlace(auctionInfo.chain, auctionInfo.nftId.contractType )
//               .methods.EndSale(auctionInfo.auctionId)
...
//         console.log(nowDate > endDate);
//         setdisableButton(false);
//         setdefaultErrorMessage("Auction is ongoing. Try cancelling.");
//         setdefaultErrorModal(true);
...
//             axios
//               .post("https://batchmint.herokuapp.com/endauction", data)
//               .then((createSaleAPI: any) => {
//                 console.log(createSaleAPI.data);
//                 axios
//                   .post(
...
//               auctionInfo.chain,
//               auctionInfo.nftId.contractType
//             )
//               .methods.endAuction(auctionInfo.auctionId)
//               .send({ from: accounts[0] });
//             if (res?.transactionHash) {
//               axios
//                 .post(
...
//       if (nftInfo.uploadedBy === "61e559cb515235e5d16373fe") {
//         const gasPrice = await axios
//           .post("https://batchmint.herokuapp.com/forcancelauction", data)
//           .then((response) => {
//             console.log(response.data);
//           });
...
//             axios
//               .post("https://batchmint.herokuapp.com/cancelauction", data)
//               .then((createSaleAPI: any) => {
//                 console.log(createSaleAPI.data);
//                 axios
//                   .post(
...
//               auctionInfo.nftId.contractType
//             )
//               .methods.cancelAuction(auctionInfo.auctionId)
//               .send({ from: accounts[0] });
//             if (res?.transactionHash) {
//               axios
//                 .post(
...
//             axios
//               .post("https://batchmint.herokuapp.com/claimnft", data)
//               .then((createSaleAPI: any) => {
//                 console.log(createSaleAPI.data);
//                 axios
//                   .post(
...
//                 <a href={nftInfo && nftInfo.cloudinaryUrl} target="_blank">
//                   {nftInfo &&
//                   nftInfo.cloudinaryUrl &&
//                   nftInfo.cloudinaryUrl.split(".").pop() == "mp4" ? (
//                     <video
...
//                     >
//                       <source
//                         src={nftInfo && nftInfo.cloudinaryUrl}
//                         type="video/mp4"
//                       />
//                     </video>
//                   ) : (
...
//                         (price === "BNB" ? (
//                           <a
//                             href={`https://bscscan.com/address/${createNFTAddressB}#code`}
//                           >
//                             0x2f37...98E95a
//                           </a>
//                         ) : price === "Eth" ? (
//                           <a
//                             href={`https://etherscan.io/address/${createNFTAddressE}#code`}
//                           >
//                             0x112f...3f74D9aE
//                           </a>
//                         ) : (
//                           price === "Matic" && (
//                             <a
//                               href={`https://polygonscan.com/address/${createNFTAddressP}#code`}
//                             >
//                               0x1549...25ff44
//                             </a>
//                           )
...
//                       <NavLink to={nftInfo && `/artist/${nftInfo.userInfo}`}>
//                         {nftInfo && nftInfo.userInfo}
//                       </NavLink>
//                     ) : (
//                       <NavLink
//                         to={
//                           auctionInfo && auctionInfo.sellerInfo
//                             ? `/artist/${auctionInfo.sellerInfo}`
//                             : nftInfo && `/artist/${nftInfo.userInfo}`
//                         }
//                       >
//                         {auctionInfo && auctionInfo.sellerInfo
...
//                     <NavLink
//                       to={`/artist/${
//                         nftInfo.mintedInfo ? nftInfo.mintedInfo : mintedBy
//                       }`}
//                     >
//                       {nftInfo.mintedInfo ? nftInfo.mintedInfo : mintedBy}
//                     </NavLink>{" "}
...
//                     endDate - nowDate > 0
//                       ? `Auction Ends ${dateArray[1]} ${dateArray[2]}, ${
//                           dateArray[3]
//                         } at ${
//                           dateHours[0] > 12 ? dateHours[0] - 12 : dateHours[0]
//                         }:${dateHours[1]}${
//                           dateHours[0] > 12 ? "pm" : "am"
//                         } ${dateZone}`
//                       : auctionInfo.auctionStatus === 3 &&
//                         (userInfo && userInfo._id) ===
//                           (auctionInfo && auctionInfo.sellerId)
//                       ? "Auction Ended"
//                       : auctionInfo.auctionStatus === 4 && "Auction Canceled"}
//                   </p>
//                 </div>
//                 <div className="price_section" style={{ position: "relative" }}>
//                   <h6>Current Price</h6>
//                   <button
//                     onClick={() => {
...
//                     <h2>
//                       {auctionInfo?.lastBid
//                         ? (auctionInfo?.lastBid / Math.pow(10, 18)).toFixed(4)
//                         : (auctionInfo?.startBid / Math.pow(10, 18)).toFixed(
//                             4
//                           )}{" "}
//                       {price}
//                     </h2>
...
//                             )}
//                           {auctionInfo.auctionStatus === 3 && (
//                             <button className="btn_brand">Sale Ended</button>
//                           )}
//                         </div>
//                       ) : (location.pathname.split("/")[1] === "auction" ||
//                           location.pathname.split("/")[1] === "nft") &&
//                         auctionInfo.auctionType === "Auction" ? (
//                         <div
...
//                               className="btn_brand"
//                               onClick={() => {
//                                 if (nowDate && endDate && nowDate < endDate) {
//                                   setPopUpShow(true);
//                                 } else {
//                                   if (
//                                     (userInfo && userInfo._id) ===
...
//                               )}
//                           {auctionInfo.auctionStatus === 3 && (
//                             <button className="btn_brand">Auction Ended</button>
//                           )}
...
//                               <h6 className="flex">
//                                 {nftBid.bidValue && <SiBinance />}{" "}
//                                 {nftBid.bidValue &&
//                                   nftBid.bidValue / Math.pow(10, 18)}
//                               </h6>
//                               <h6>
//                                 {nftBid.username.length > 15
//                                   ? nftBid.username.substring(0, 7)
//                                   : nftBid.username}
//                                 {nftBid.username.length > 15 && "..."}
//                                 {nftBid.username.length > 15 &&
//                                   nftBid.username.substring(
//                                     nftBid.username.length - 7
//                                   )}
//                               </h6>
//                               <h6>{nftBid.createdAt.split("T")[0]}</h6>
//                             </div>
//                           );
//                         })}
//                     </div>
...
//                             >
//                               {nftState.state === "Minted" ? (
//                                 <BsCartPlus />
//                               ) : nftState.state === "Auction" ? (
//                                 <RsAuctionFill />
//                               ) : (
...
//                               style={{ justifyContent: "left" }}
//                             >
//                               {nftState.price && <SiBinance />}{" "}
//                               {nftState.price &&
//                                 nftState.price / Math.pow(10, 18)}
//                             </h6>
//                             <h6>
//                               {nftState.from.length > 15
//                                 ? nftState.from.substring(0, 7)
//                                 : nftState.from}
//                               {nftState.from.length > 15 && "..."}
//                               {nftState.from.length > 15 &&
//                                 nftState.from.substring(
//                                   nftState.from.length - 7
//                                 )}
//                             </h6>
//                             <h6>
//                               {nftState.to.length > 15
//                                 ? nftState.to.substring(0, 7)
//                                 : nftState.to}
//                               {nftState.to.length > 15 && "..."}
//                               {nftState.to.length > 15 &&
//                                 nftState.to.substring(nftState.to.length - 7)}
//                             </h6>
//                             <h6>
//                               {nftState.date && nftState.date.split("T")[0]}
//                             </h6>
//                           </div>
//                         );
//                       })}
...
//                   console.log(location.pathname.split("/")[1] === "sale");
//                 } else {
...
//                 billingAddress
//               > */}
//               <h5 className="insidecommingSoon">Pay Using Stripe</h5>
